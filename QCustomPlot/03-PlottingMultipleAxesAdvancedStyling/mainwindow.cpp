 ...
 * Now, let's look at a more complex example for creating the demo screenshot
 * which contains the five graphs on four axes, textured filling, vertical error
 * bars, a legend, dots as decimal separators etc.
*/
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent) , ui(new Ui::MainWindow)
{
  ...
  // by default, the legend is in the insert layout of the main axis rect. So this is how we access it to change legend placement:
  ...
  QList<double> x0(25), y0(25);
  QList<double> x1(15), y1(15), y1err(15);
  QList<double> x2(250), y2(250);
  QList<double> x3(250), y3(250);
  QList<double> x4(250), y4(250);
